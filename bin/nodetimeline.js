...
releasesType.forEach(release => {
  ...
  console.log('      - There are currently ' + release.releases.getSafe().length + ' releases in the Node.js ' + release.version + ' release line that have zero known vulnerabilities.')
